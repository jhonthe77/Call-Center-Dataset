...
explicacion_info2='''
Como podemos apreciar, tenemos un nuevo DataFrame con más datos y con las columnas con la misma cantidad de datos y su tipo de dato acorde. Este DataFrame está filtrado donde omití 946 filas que tenían valores nulos. No apliqué ninguna técnica para trabajar con ellos ya que no afectan la calidad de los datos, por ejemplo, una de varias es rellenarlos con el promedio. Pero se puede apreciar que no afectan la calidad de los datos y por eso opté por rellenarlos con ceros. Llegué a esta conclusión mostrando las descripciones estadísticas básicas del DataFrame, como son el promedio, la distribución estándar, el valor máximo, el valor mínimo y los cuartiles de las columnas que son el 25%, 50% y el 75%. Es así como están distribuidos los datos en el DataFrame.

Para concluir, vemos que el DataFrame está enriquecido con nuevos datos creados a partir de los datos existentes. Luego, pasaré a las visualizaciones analizando variables importantes del DataFrame de manera, tanto individual como agrupadas. Finalmente, mostraré al final las estadísticas básicas del DataFrame para que tengan una idea de lo que les mencioné anteriormente.
'''