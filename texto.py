...
explicacion_info2='''
Como podemos apreciar, tenemos un nuevo DataFrame con más datos y con las columnas con la misma cantidad de datos y su tipo de dato acorde. Este DataFrame está filtrado donde omití 946 filas que tenían valores nulos. No apliqué ninguna técnica para trabajar con ellos, por ejemplo, una de varias es rellenarlos con el promedio. Pero se puede apreciar que afectan la calidad de los datos y por eso opté por rellenarlos con ceros. Llegué a esta conclusión mostrando las descripciones estadísticas básicas del DataFrame, como son el promedio, la distribución estándar, el valor máximo, el valor mínimo y los cuartiles de las columnas que son el 25%, 50% y el 75%. Es así como están distribuidos los datos en el DataFrame.
